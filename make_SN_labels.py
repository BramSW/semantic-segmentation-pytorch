...
def main():
    ...
    image_dir = '' # directory containing NYU images
    splits_dir = '' # directory containing train/test splits text files
    mat_files_dir = '' # directory containing .mat files ground truth

    # The following directories are populated with data
    dst_normals_dir = '' # dst dir where normal files will be created
    copy_to_dir = '' # directory where images are copied in the format needed for training
    json_dir = '' # directory where metadata json is created
    ...
    vocab_file = 'vocab%d.mat' % (NUM_NORMALS_CLASSES)
